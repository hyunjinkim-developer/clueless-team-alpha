...
# Session Management
# Note: Clear django_session table if session issues persist:
# python manage.py dbshell
# sqlite> DELETE FROM django_session;
SESSION_COOKIE_NAME = 'sessionid'
SESSION_COOKIE_HTTPONLY = True  # Prevent JavaScript access to session cookies
SESSION_COOKIE_SAMESITE = 'Strict'  # Prevent cookie sharing across sites
SESSION_COOKIE_AGE = 1800  # 30-minute session duration
SESSION_COOKIE_PATH = '/'  # Root path for cookies
...
# SESSION_ENGINE = 'django.contrib.sessions.backends.cached_db'  # Use Redis for performance
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Include static directory for images
]
